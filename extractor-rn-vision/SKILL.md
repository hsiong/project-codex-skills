...
```bash
python3 extractor-rn-vision/scripts/extractor_rn_x11.py '<url1>' '<url2>'
```

or:

```bash
python3 extractor-rn-vision/scripts/extractor_rn_x11.py '62 ... https://example.com/a' '88 ... https://example.com/b'
```
